...
public class OutputGoodsAdapter extends BaseAdapter {
	...
	public OutputGoodsAdapter(int type,Activity mActivity, Context context, 
			List<PresentGoods> goodsListAll, List<PresentGoods> goodsListCondition, Handler handler) {
		super();
		this.type = type;
...
//				curDel_btn.setVisibility(View.INVISIBLE);运行时异常
